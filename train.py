...
def parse_args(args):
    ...
    parser.add_argument('--freeze-backbone', help='Freeze training of backbone layers.', action='store_true')#V
    parser.add_argument('--freeze-bn', help='Freeze training of BatchNormalization layers.', action='store_true')#V
    parser.add_argument('--weighted-bifpn', help='Use weighted BiFPN', action='store_true')#V

    parser.add_argument('--batch-size', help='Size of the batches.', default=1, type=int)
    parser.add_argument('--phi', help='Hyper parameter phi', default=0, type=int, choices=(0, 1, 2, 3, 4, 5, 6))#V
    parser.add_argument('--gpu', help='Id of the GPU to use (as reported by nvidia-smi).')#V
    parser.add_argument('--epochs', help='Number of epochs to train.', type=int, default=15)#V
    parser.add_argument('--steps', help='Number of steps per epoch.', type=int, default=10000)#V
    ...
    parser.add_argument('--no-evaluation', help='Disable per epoch evaluation.', dest='evaluation',
                        action='store_false')
    parser.add_argument('--random-transform', help='Randomly transform image and annotations.', action='store_true')#V
